  ...
  return (
    <Box backgroundColor="rgba(29, 33, 38, 0.4)" padding="20px"> 
      ...
      <Box display="flex" flexDirection={isSmallScreen ? 'column' : 'row'} width="100%" margin="auto" mt="70px" gap="20px">
        <Box width="100%" height={isSmallScreen ? '200px' : '400px'} borderRadius="10px" backgroundSize="cover" backgroundPosition="center" style={{ backgroundImage: `url('https://images.pexels.com/photos/5591710/pexels-photo-5591710.jpeg?auto=compress&cs=tinysrgb&w=600')`,}} />
