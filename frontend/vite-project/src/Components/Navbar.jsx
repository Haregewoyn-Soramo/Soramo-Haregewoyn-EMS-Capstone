      ...
      <FlexBetween gap="1.5rem">
        {user ? (
          <div>
            ...
            <Button sx={{ color: theme.palette.secondary[200] }} onClick={logout}>Sign Out</Button> 
          </div>
        ) : (
          <Button sx={{ color: theme.palette.secondary[200] }} onClick={() => navigate('/signin')}>Sign In</Button>
        )}
